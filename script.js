    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טופ גרופ נדל\"ן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3f7ee7cd-806c-44be-9277-7aa1a38c3931',
                    name: data.name || '',
                    email: data.email || '',
